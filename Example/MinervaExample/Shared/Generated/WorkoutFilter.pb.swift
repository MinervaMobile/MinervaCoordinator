...
// Source: WorkoutFilterProto.proto
//
...
struct WorkoutFilterProto {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var startDateTimestamp: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  var hasStartDateTimestamp: Bool {return _storage._startDateTimestamp != nil}
  /// Clears the value of `startDateTimestamp`. Subsequent reads from it will return its default value.
  mutating func clearStartDateTimestamp() {_uniqueStorage()._startDateTimestamp = nil}

  var endDateTimestamp: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  var hasEndDateTimestamp: Bool {return _storage._endDateTimestamp != nil}
  /// Clears the value of `endDateTimestamp`. Subsequent reads from it will return its default value.
  mutating func clearEndDateTimestamp() {_uniqueStorage()._endDateTimestamp = nil}

  var startTimeTimestamp: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  var hasStartTimeTimestamp: Bool {return _storage._startTimeTimestamp != nil}
  /// Clears the value of `startTimeTimestamp`. Subsequent reads from it will return its default value.
  mutating func clearStartTimeTimestamp() {_uniqueStorage()._startTimeTimestamp = nil}

  var endTimeTimestamp: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  var hasEndTimeTimestamp: Bool {return _storage._endTimeTimestamp != nil}
  /// Clears the value of `endTimeTimestamp`. Subsequent reads from it will return its default value.
  mutating func clearEndTimeTimestamp() {_uniqueStorage()._endTimeTimestamp = nil}
...
extension WorkoutFilterProto: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "WorkoutFilterProto"
  ...
  static func ==(lhs: WorkoutFilterProto, rhs: WorkoutFilterProto) -> Bool {
